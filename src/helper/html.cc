...
std::wstring HelperHtml::ReplaceWideCharByEntity(std::wstring wstr, int str_len, int offset, int offset_left,
...
std::wstring HelperHtml::ReplaceWideCharByEntity(std::wstring wstr, int str_len, int offset, std::wstring replacement) {
  return ReplaceWideCharByEntity(std::move(wstr), str_len, offset, offset - 1, offset + 1, std::move(replacement));
}

std::string HelperHtml::Decode(std::string str) {
